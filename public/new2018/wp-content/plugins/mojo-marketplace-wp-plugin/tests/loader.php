...
function mm_jpo_test( $file ) {
	...
	if ( $onboard_time > time() ) {
		return mm_ab_test_file( 'jetpack-onboarding-v1.7.4', $file, 'vendor/jetpack/jetpack-onboarding/jetpack-onboarding.php', 'tests/jetpack-onboarding/jetpack-onboarding.php', 0, DAY_IN_SECONDS * 90 );
	} else {
		return false;
	}
}
