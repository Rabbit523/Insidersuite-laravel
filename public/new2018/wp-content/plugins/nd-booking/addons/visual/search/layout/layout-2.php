...
$str .= '
    ...
    <div class="nd_booking_border_1_solid_grey nd_booking_section '.$nd_booking_class.' ">
                    ...
                    <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                      <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                        <div class="nd_booking_section nd_booking_position_relative">
                          ...
                          <img class="nd_booking_position_absolute nd_booking_left_0 nd_booking_top_0 nd_booking_guests_decrease nd_booking_cursor_pointer" alt="" width="20" src="'.plugins_url().'/nd-booking/assets/img/icons/icon-decrease-grey.svg">
                          ...
                          <img class="nd_booking_position_absolute nd_booking_right_0 nd_booking_top_0 nd_booking_guests_increase nd_booking_cursor_pointer" alt="" width="20" src="'.plugins_url().'/nd-booking/assets/img/icons/icon-increase-grey.svg">
