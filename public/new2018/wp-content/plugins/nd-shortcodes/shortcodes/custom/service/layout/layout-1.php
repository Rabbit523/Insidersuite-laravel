...
$str .= '
    ...
    <div class="nd_options_section nd_options_position_relative '.$nd_options_class.'">
        <a rel="'.$nd_options_link_rel.'" '.$nd_options_link_target_output.' href="'.$nd_options_link_url.'"><img alt="" class="nd_options_position_absolute nd_options_left_0" width="50" src="'.$nd_options_image_src[0].'"></a>
