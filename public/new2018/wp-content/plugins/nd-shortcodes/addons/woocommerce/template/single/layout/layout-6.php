<div id="nd_options_woocommerce_header_img_layout_6" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_meta_box_woocommerce_header_img_position ?>" style="background-image:url(<?php echo $nd_options_meta_box_woocommerce_header_img; ?>);">
