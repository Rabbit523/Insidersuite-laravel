...
<style>
	...
	/*price*/
	.woocommerce.woocommerce-page .product .summary.entry-summary  .price {font-size: 40px;line-height: 40px;color: <?php echo $nd_options_customizer_font_color_p;  ?>;	font-family: '<?php echo $nd_options_font_family_h; ?>', sans-serif;}
