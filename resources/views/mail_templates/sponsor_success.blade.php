...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:;">
  ...
  <!-- IMG TOP -->
  <tr>
    <td><a href="https://www.insidersuite.com/"><img src="http://insidersuite.com/images/Luxury-Travel.png" width="600" height="280" alt="Insider Suite" border="0" style="display:block;width:100%;max-width:600px;height:auto"></a></td></tr>
  <!-- /IMG TOP -->
  ...
  <!-- titre -->
  <tr>
  <td align="center"><i style="font-size:22px; font-family: Georgia, serif; color:#1d1d1d;">Congratulation you earned $75 AUD </i></td>
  </tr>
  <!-- /titre -->
  ...
  <!-- texte -->
  <tr>
  <td align="center" style="mso-height-rule: exactly; line-height: 16px;"><span style="font-size:14px; font-family: Arial, Helvetica, sans-serif; color:#1d1d1d;">

Congratulation you received $75 AUD off your next trip. <br><br>

You sponsored {{$sponsored_name}} and they have made their first booking. As promised we give you a voucher that can be redeemed for any trip that you purchase on insidersuite.com. 
<br><br>

<div align="center"> 

Use code at checkout:<br><br>
<i class="myButton2" style="font-size:20px; font-family: Georgia, serif; color:#1d1d1d;">{{$voucher_no}}</i>
<br><br><br>
...
<td align="center"><a href="https://www.instagram.com/insidersuite/" target="_blank"><img class="CToWUd" src="https://www.insidersuite.com/images/instagram.png" alt="Instagram" width="23" height="23" border="0" /></a></td>
  ...
  <!-- TEXTE LEGAL -->
  <tr>
  <td align="center" style="padding:10px;font-size: 11px; font-family: Arial, Verdana; color:#666666;"> <span> *This voucher cannot be redeemed for cash or credit and cannot be returned or resold.<br />This voucher must be redeemed within 12 months of the issued date.<br /> Please add to your address book to ensure you receive future emails from us.<br />  </td>
  </tr>
  <!-- /TEXTE LEGAL -->
  </table>
  <!-- /TABLEAU PRINCIPAL -->
