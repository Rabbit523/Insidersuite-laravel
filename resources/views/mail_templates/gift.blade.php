...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="sg:pagetag" content="" /><meta name="sg:flowtag" content="" />
  ...
  <title>Insider Suite | Gift card</title>
<!-- CSS START -->
<style>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:;">
  ...
  <!-- IMG TOP -->
  <tr>
    <td><a href="https://www.insidersuite.com/"><img src="https://www.insidersuite.com/images/gift_card_email.png"  alt="Insider Suite" border="0" style="display: block; width:100%; max-width:600px; height:100%;"/></a></td></tr>
  <!-- /IMG TOP -->
  ...
  <!-- titre -->
  <tr>
  <td align="center"><i style="font-size:22px; font-family: Georgia, serif; color:#1d1d1d;">Congratulation {{ $data['sender_name'] }}!</i></td>
  </tr>
  <!-- /titre -->
  
  <!-- separateur -->
  <tr>
  <td align="center" style="padding:20px 20px 40px;" class="p20"><img src="https://www.insidersuite.com/images/seperatior.png" width="30" height="4" alt="Insider Suite" border="0" style="display: block; margin: auto;"/></td>
  </tr>
...
{{ $data['beneficiary_name'] }} purchased a Insider Suite Gift Card to you. The best way for celebration is to pack up for vacation. <br><br>

Here is what you {{ $data['beneficiary_name'] }} has to tell you something: 

{{ $data['message'] }}
<br><br>

<div align="center"> 
 The card can be redeemed for any trip that you purchase on insidersuite.com. <br>
Just add the code below when you checkout and you'll automatically get <b>${{$data['amount']}}</b> off on your trip. <br><br>


Use code at checkout:<br><br>
<i class="myButton2" style="font-size:20px; font-family: Georgia, serif; color:#1d1d1d;">{{$data['voucher_no']}}</i>
<br><br><br>
<a href="https://www.insidersuite.com/" class="myButton" style="font-size:20px; font-family: Georgia, serif;">Let's order</a>
  ...
  <tbody>
  <tr>
<td align="center"><a href="https://www.facebook.com/insidersuite/" target="_blank" ><img class="CToWUd" src="https://www.insidersuite.com/images/facebook.png" alt="Facebook" width="23" height="23" border="0" /></a></td>
<td align="center"><a href="https://www.instagram.com/insidersuite/" target="_blank"><img class="CToWUd" src="https://www.insidersuite.com/images/instagram.png" alt="Instagram" width="23" height="23" border="0" /></a></td>
  ...
  <!-- TEXTE LEGAL -->
  <tr>
  <td align="center" style="padding:10px;font-size: 11px; font-family: Arial, Verdana; color:#666666;"> <span> *This card cannot be redeemed for cash or credit and cannot be returned or resold.<br />This card must be redeemed within 12 months of the date of purchase,  after which date the PIN will expire. <br /> Please add to your address book to ensure you receive future emails from us.<br />  </td>
  </tr>
  <!-- /TEXTE LEGAL -->
  </table>
  <!-- /TABLEAU PRINCIPAL -->
...
<img height='0' width='0' alt='' /></body></html>
