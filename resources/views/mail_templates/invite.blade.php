...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="sg:pagetag" content="" /><meta name="sg:flowtag" content="" />
  ...
  <title>Insider Suite | Invite Page</title>
<!-- CSS START -->
<style>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:;">
  ...
  <!-- IMG TOP -->
  <tr>
    <td><a href="https://www.insidersuite.com/"><img src="https://www.insidersuite.com/images/Luxury-Travel.png" width="600" height="280" alt="Insider Suite" border="0" style="display: block; width:100%; max-width:600px; height:auto;"/></a></td></tr>
  <!-- /IMG TOP -->
  <tr>
  ...
  <!-- titre -->
  <tr>
  <td align="center"><i style="font-size:32px; font-family: Georgia, serif; color:#1d1d1d;  font-style: italic;">Hi, we want to share the trip itinerary of {{$sender_name}}.</i></td>
  </tr>
  <!-- /titre -->
  
  <!-- separateur -->
  <tr>
  <td align="left" style="padding:20px 20px 40px;" class="p20"><img src="https://www.insidersuite.com/images/seperatior.png" width="30" height="4" alt="Insider Suite" border="0" style="display: block; margin: auto;"/></td>
  </tr>
  ...
  @if($_message != "")
  <tr>
    <td align="center">Here is what {{$sender_name}} has to tell you : {{$_message}}.</td>
  </tr>
  @endif
  </table></td>
  </tr>
  ...
  <!-- TEXTE LEGAL -->
  <tr>
  <td align="center" style="padding:10px;font-size: 11px; font-family: Arial, Verdana; color:#666666;"> <span> *Through our global-minded member base, our partners are able to engage to global audiences<br />, cultivate loyal consumers and generate new profit-making opportunities.<br />Partner with us ? Please get in touch with us.<br />  </td>
  </tr>
  <!-- /TEXTE LEGAL -->
  </table>
  <!-- /TABLEAU PRINCIPAL -->
